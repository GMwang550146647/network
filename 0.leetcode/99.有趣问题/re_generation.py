...
class ReParse():
    ...
    def get_pattern_tree(self, left, present):
        ...
        :param left:    splited_pattern 中暂未解析的部分
        :param present: 已解析的部分生成的树结构
        :return:
        """
        if len(left) == 0:
    ...
    def parse_tree(self, left, pre_arr):
        ...
        作用：
        从pattern_tree中提取出
        :param left:    剩下未解析的部分，pattern_tree剩下未解析的部分
        :param pre_arr: 已经解析了的部分，可以看做是前面的所有可能组合
        :return:
        """
        # 每次处理列表的一个元素
